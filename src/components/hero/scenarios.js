...
export const growth = {
  id: 'growth',
  label: 'Growth',
  // a real shop: retro football and cricket jerseys out of Bengaluru
  store: 'Classic Jerseys',
  initials: 'CJ',
  scenario: {
    title: 'Abandoned cart',
    blurb: 'A fan adds a jersey to cart and leaves. Bring them back in the shop’s own voice, without inventing a discount.',
  },
  ...
  chapters: [
    ...
    { title: 'Closing the cart', blurb: 'A 24-hour hold is allowed. A percentage off is not. Recovered at 6:40 am.', at: 6 },
  ],
  sources: [
    {
      id: 'cart', title: 'Cart, checked at send time', by: 'Shopify', added: 'at send time', live: true,
      body: ['Argentina x Messi 2022 World Cup jersey, size L, ₹4,999, left at checkout 8:47 pm.'],
    },
    {
      id: 'voice', title: 'Brand voice', by: 'store owner', added: '2 months ago',
      body: [
        'We talk like a fan at the counter, not a brand.',
        'You can hold a rare jersey for 24 hours. Never a percentage off.',
        'One message. If they do not answer, leave them alone.',
      ],
    },
    {
      id: 'notes', title: 'Product notes, jerseys', by: 'shop staff', added: '3 weeks ago',
      body: [
        'The Argentina 2022 runs a size big. Most people go one size down.',
        'It is the fan version. The player version is a slimmer cut.',
        'Rare pieces are never discounted.',
      ],
    },
    {
      id: 'history', title: 'Order history', by: 'Growth agent', added: 'Mar 14',
      body: ['Mar 14: India Cricket 2011 World Cup jersey, size L, one.', 'Placed by {mask}.'],
    },
  ],
  thread: [
    { id: 't0', kind: 'system', text: 'Left in cart, 8:47 pm' },
    { id: 'c0', kind: 'card', title: 'Argentina x Messi 2022 World Cup', sub: '₹4,999 · size L' },
    { id: 'ts1', kind: 'time', text: 'Today' },
    { id: 'm1', from: 'agent', at: '9:47 pm', draws: [['cart', 0], ['notes', 0], ['voice', 0]],
      text: 'Hey Rohan, the Argentina 2022 is still in your cart. One thing before you decide: it runs a size big, most people go one down.' },
    { id: 'm2', from: 'customer', at: '6:31 am', text: 'Ah okay. What size did I take last time? The India 2011 one from you.' },
    { id: 'm3', from: 'agent', at: '6:31 am', draws: [['history', 0], ['notes', 0]],
      text: 'That was an L, back in March. This one runs bigger, so an M should sit the same on you.' },
    { id: 'm4', from: 'agent', at: '6:32 am', draws: [['voice', 1]],
      text: 'And I can hold it for you till tomorrow night, if that helps.' },
    { id: 'm5', from: 'customer', at: '6:40 am', text: 'Sold. Ordered the M.' },
  ...
  steps: [
    { upto: 2, hold: 2400, cap: 'A fan leaves. The agent waits an hour before it says anything.' },
    ...
    { upto: 6, sel: 'm3', hold: 4600, cap: 'Last March’s order, with the email masked.' },
    { upto: 7, typing: 1100, hold: 3300, cap: 'A hold is allowed. A percentage off is not.' },
