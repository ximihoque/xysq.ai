...
export default function SEO({
  ...
  const fullTitle = title ? `${title} · xysq.ai` : 'Context Platform for AI agents | xysq.ai'
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image:alt" content={imageAlt || title || 'Context Platform for AI agents | xysq.ai'} />
