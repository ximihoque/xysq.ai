        ...
        <div className="mm-head">
          ...
          <div className="reveal" style={{ transitionDelay: '0.1s' }}>
            <p className="mm-head-body">
              Most AI reads your text. We read <strong>you</strong>. Every modality: your voice, your
              camera, your words, your tone, your silence. All of it is part of how we build a living portrait
              of who you are. Not one dimension. All of you.
            </p>
            <p className="mm-head-body" style={{ marginTop: '20px' }}>
              This isn't a feature. It's the foundation.{' '}
              <strong className="cyan">Multimodal is in our DNA.</strong>
            </p>
          </div>
        </div>
