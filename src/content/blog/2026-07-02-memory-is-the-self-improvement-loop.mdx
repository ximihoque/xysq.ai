...
category: "Insight"
cover: "https://storage.googleapis.com/xysq_public/blogs/memory-is-the-self-improvement-loop/hero.png"
...
<Figure src="https://storage.googleapis.com/xysq_public/blogs/memory-is-the-self-improvement-loop/hero.png" alt="Four AI memory systems (Mem0, Letta, Zep, Memora) with each system's distinctive idea and one verified benchmark number." caption="Four bets on what the store should be. Each number carries its baseline." />
