...
const STEPS = [
  ...
  { view: 'sources', up: true, hold: 3600, cam: [1.22, 100, 0], cur: [92.8, 22.6],
    cap: 'Add one more.' },
  { view: 'sources', added: true, hold: 3400, cam: WIDE, cur: [8.7, 22.8], tap: true,
    cap: 'Stored as written. We never edit your document.' },
  { view: 'pages', added: true, hold: 3000, cam: WIDE, cur: [58.8, 22.8], tap: true,
    cap: 'It goes onto the page you already have, not a new one.' },
  { view: 'page', added: true, hold: 3000, cam: WIDE, cur: [34.2, 29.4], tap: true,
  ...
  { view: 'page', added: true, log: true, hold: 3800, cam: [1.25, 100, 18], cur: [86.8, 24.8],
    cap: 'Every change, and who made it.' },
  { view: 'page', added: true, log: true, sup: true, hold: 4400, cam: [1.32, 0, 14], cur: [46.2, 30.4],
